...
import {
	type UseSiteLocation,
	useSiteLocation
} from '../Hooks/locations/useLocation'
import {
	type UseProcessor,
	useProcessor
} from '../Hooks/processor/useProcessor'
import {
	type UseMemoryRamType,
	useMemoryRamType
} from '../Hooks/memoryRam/useMemoryRamType'
import {
	type UseHardDriveCapacity,
	useHardDriveCapacity
} from '../Hooks/hardDrive/useHardDriveCapacity'
import {
	type UseHardDriveType,
	useHardDriveType
} from '../Hooks/hardDrive/useHardDriveType'
import {
	type UseTypeOfSite,
	useTypeOfSite
} from '../Hooks/locations/useTypeOfSite'
import {
	type UseOperatingSystemVersions,
	useOperatingSystemVersions
} from '../Hooks/operatingSystem/useOperatingSystemVersion'
import {
	type UseOperatingSystemArq,
	useOperatingSystemArq
} from '../Hooks/operatingSystem/useOperatingSystemArq'
import {
	type UseInputType,
	useInputType
} from '../Hooks/inputType/useInputType'
import { type UseRegion, useRegion } from '../Hooks/locations/useRegion'
import { type UseCities, useCity } from '../Hooks/locations/useCity'
import {
	type UseStates,
	useCountryStates
} from '../Hooks/locations/useCountryStates'
import { type UseSites, useSite } from '../Hooks/locations/site/useSite'
import {
	type UseMainCategory,
	useMainCategory
} from '../Hooks/mainCategory/useMainCategory'
