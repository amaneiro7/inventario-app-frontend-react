...
const Input = lazy(
	async () =>
		await import('@/sections/components/text-inputs/Input').then(m => ({
			default: m.Input
		}))
)
const PageTitle = lazy(
	async () => await import('@/sections/components/Typography/PageTitle')
)
const Button = lazy(
	async () => await import('@/sections/components/button/button')
)
const Copyright = lazy(
	async () =>
		await import('@/sections/components/Copyright').then(m => ({
			default: m.Copyright
		}))
)
const CircleSpinningIcon = lazy(async () =>
	import('@/sections/components/icon/CircleSpinning').then(m => ({
		default: m.CircleSpinningIcon
	}))
)
const LockIcon = lazy(
	async () =>
		await import('@/sections/components/icon/LockIcon').then(m => ({
			default: m.LockIcon
		}))
)
const UnlockIcon = lazy(
	async () =>
		await import('@/sections/components/icon/UnlockIcon').then(m => ({
			default: m.UnlockIcon
		}))
)
const MailIcon = lazy(
	async () =>
		await import('@/sections/components/icon/MailIcon').then(m => ({
			default: m.MailIcon
		}))
)
