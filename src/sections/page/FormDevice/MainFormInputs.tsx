...
const StatusComboBox = lazy(
	async () => await import('@/sections/components/combo_box/StatusComboBox')
)
const CategoryComboBox = lazy(
	async () => await import('@/sections/components/combo_box/CategoryComboBox')
)
const MainCategoryComboBox = lazy(
	async () =>
		await import('@/sections/components/combo_box/MainCategoryComboBox')
)
const BrandComboBox = lazy(
	async () => await import('@/sections/components/combo_box/BrandComboBox')
)
const ModelComboBox = lazy(
	async () => await import('@/sections/components/combo_box/ModelComboBox')
)
const SerialInput = lazy(
	async () => await import('@/sections/components/text-inputs/SerialInput')
)
const ActivoInput = lazy(
	async () => await import('@/sections/components/text-inputs/ActivoInput')
)
const EmployeeComboBox = lazy(
	async () => await import('@/sections/components/combo_box/EmployeeComboBox')
)
const LocationComboBox = lazy(
	async () => await import('@/sections/components/combo_box/LocationComboBox')
)
const ObservationInput = lazy(
	async () =>
		await import('@/sections/components/text-inputs/ObservationInput')
)
const StockNumberInput = lazy(async () =>
	import('@/sections/components/text-inputs/StockNumberInput').then(m => ({
		default: m.StockNumberInput
	}))
)
