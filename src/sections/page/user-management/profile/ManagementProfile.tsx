...
const UserManagementAction = lazy(async () => import('@/sections/components/Select/UserManagementActions').then(m => ({ default: m.UserManagementAction })))
...
const ResetHandle = lazy(async () => import('./Resethandle').then(m => ({ default: m.ResetHandle })))
const DeleteHandle = lazy(async () => import('./Deletehandle').then(m => ({ default: m.DeleteHandle })))
