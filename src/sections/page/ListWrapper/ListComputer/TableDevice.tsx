...
const Table = lazy(async () =>
	import('@/sections/components/Table/Table').then(m => ({
		default: m.Table
	}))
)
const TableHeader = lazy(async () =>
	import('@/sections/components/Table/TableHeader').then(m => ({
...
const TableBody = lazy(async () =>
	import('@/sections/components/Table/TableBody').then(m => ({
		default: m.TableBody
	}))
)
const TableHead = lazy(async () =>
	import('@/sections/components/Table/TableHead').then(m => ({
		default: m.TableHead
	}))
)
