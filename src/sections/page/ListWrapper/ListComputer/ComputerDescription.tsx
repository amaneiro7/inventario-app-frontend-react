			...
			>
				...
				<div className="flex flex-col gap-2">
					...
					<div className="flex gap-4">
						<TableCellDescInfo
							...
							text={
								device.computer
									? `${device?.computer?.processor?.cores}`
									: ''
							}
						/>
						<TableCellDescInfo
							...
							text={
								device.computer
									? `${device?.computer?.processor?.frequency}`
									: ''
							}
						/>
					</div>
				...
				<div className="flex flex-col gap-2">
					...
					<TableCellDescInfo
						title="Tipo"
						text={
							device?.computer?.hardDriveType?.name ?? 'No Aplica'
						}
					/>
				</div>
				<div className="flex flex-col gap-2">
					...
					<TableCellDescInfo
						...
						text={
							device?.computer?.operatingSystemArq?.name ??
							'No Aplica'
						}
					/>
				</div>
