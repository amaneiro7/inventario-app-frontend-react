...
const MemoryRamTypeComboBox = lazy(async () =>
	import('@/sections/components/combo_box/MemoryRamTypeComboBox').then(m => ({
		default: m.MemoryRamTypeComboBox
	}))
)
const NumberInput = lazy(async () =>
	import('@/sections/components/number-inputs/NumberInput').then(m => ({
...
export function AddModelComputer({
	formData,
	onChange,
	disabled,
	error,
