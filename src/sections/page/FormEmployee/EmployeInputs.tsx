...
import {
	...
	type FormEmployeeRequired,
	type DefaultEmployeeProps
} from '@/sections/Hooks/employee/DefaultInitialState'

const EmployeeUserNameInput = lazy(
	async () =>
		await import('@/sections/components/text-inputs/UserNameInput').then(
			m => ({ default: m.EmployeeUserNameInput })
		)
)
interface Props {
