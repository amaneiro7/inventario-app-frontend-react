...
const ProtectedRoute = lazy(async () => await import('./ProtectedRoute.tsx').then(m => ({ default: m.ProtectedRoute })))
...
const ListFinantialPrinter = lazy(async () => await import('../page/ListWrapper/ListFinantialPrinterPrinter/ListFinantialPrinter.tsx'))
