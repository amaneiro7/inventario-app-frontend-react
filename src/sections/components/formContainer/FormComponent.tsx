...
const LastUpdated = lazy(async () =>
	import('../LastUpdated').then(m => ({ default: m.LastUpdated }))
)
const UpdatedBy = lazy(async () =>
	import('../UpdatedBy').then(m => ({ default: m.UpdatedBy }))
)
...
const ResetIcon = lazy(() =>
	import('../icon/ResetIcon').then(m => ({ default: m.ResetIcon }))
)
