...
const DetailsWrapper = lazy(async () =>
	import('../DetailsWrapper/DetailsWrapper').then(m => ({
			...
			<DetailsWrapper borderColor="blue">
				<DetailsBoxWrapper>
					<Subtitle
						variant="h2"
						color="blue"
						text={`Gestión de ${title} - ${isAddForm ? 'Registre un nuevo' : 'modifique un'} ${title}`}
					/>
