...
const BrandDialog = lazy(async () =>
	import('../Dialog/BrandDialog').then(m => ({ default: m.BrandDialog }))
)
...
export default function BrandComboBox({
	...
	const {
		useBrand: { brands, loading }
	} = useAppContext()
	const [open, setOpen] = useState(false)
	const [dialogValue, setDialogValue] =
		useState<BrandPrimitives>(initialBrandState)
	...
	const filterdBrand = useMemo(() => {
		...
		return brands.filter(brand =>
			(brand as BrandApiResponse).model?.some(
