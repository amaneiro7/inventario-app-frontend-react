...
const EditIcon = lazy(async () =>
	import('../../components/icon/EditIcon').then(m => ({
		default: m.EditIcon
	}))
)
const ResetIcon = lazy(async () =>
	import('../../components/icon/ResetIcon').then(m => ({
		default: m.ResetIcon
	}))
)
const ThrashIcon = lazy(async () =>
	import('../../components/icon/ThrashIcon').then(m => ({
		default: m.ThrashIcon
	}))
)
const StepsText = lazy(async () =>
	import('../../components/stepsToFollow/StepsText').then(m => ({
		default: m.StepsText
	}))
)
