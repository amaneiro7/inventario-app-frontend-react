...
const DesciptionTitle = lazy(async () =>
	import('./DescriptionTitle').then(m => ({ default: m.DesciptionTitle }))
)
interface Props
	...
	children?: React.ReactElement<
		| typeof DescriptionDesc
		| typeof EditHandle
		| typeof ResetHandle
		| typeof DeleteHandle
	>
}
export function DescriptionListElement({ title, children }: Props) {
	return (
