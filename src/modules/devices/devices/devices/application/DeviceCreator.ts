import {
	Computer,
	type ComputerPrimitives
} from '../../../fetures/computer/domain/Computer'
import {
	HardDrive,
	type HardDrivePrimitives
} from '../../../fetures/hardDrive/hardDrive/domain/HardDrive'
...
export class DeviceCreator {
	...
	async create(params: DevicePrimitives): Promise<void> {
		...
		// logica cuando es disco duro
			...
			HardDrive.isHardDriveCategory({ categoryId: params.categoryId })
		) {
