...
import {
	CategoryDefaultData,
	CategoryValues
} from '../../../category/domain/CategoryDefaultData'
...
} from '../modelComputer/ModelComputer'
...
export class ModelLaptop extends ModelComputer {
	...
	public static create(params: ModelLaptopPrimitives) {
		if (!ModelLaptop.isLaptopCategory({ categoryId: params.categoryId })) {
			throw new Error(
				'No Pertenece a esta categoria, solo se permite la categoria de Laptops'
			)
		}
